import type { SelectableOption, SelectOption } from "../types/type";
...
export const singleOption1: SelectableOption = { code: '01', name: '옵선1', colorMain: '#FFE6EB', colorSub: '#FFEFF2', isSelected: true };
