import type { Section, Task } from "../types/type";
import { option3, option5, options, priorityHigh, priorityLow, priorityMedium, priorityUrgent, singleOptions, statusCompleted, statusInProgress, statusWaiting } from "./select-option-mock";
